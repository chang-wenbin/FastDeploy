...
@dataclass
class TokenSparseAttentionMetadata(AttentionMetadata):
    """
...
class TokenSparseAttentionBackend(AttentionBackend):
    """
    TokenSparseAttentionBackend backend implementation
    """

    __infer_dynamic_dims_fields__ = ["attention_metadata"]
    attention_metadata: TokenSparseAttentionMetadata
    ...
    def __init__(
        ...
        """
        super().__init__()
        self.attention_metadata: TokenSparseAttentionMetadata = None
    ...
    def get_kv_cache_shape(
        ...
        indexer_cache_shape = [max_num_blocks, self.kv_num_heads, self.block_size, self.head_dim]
    ...
    def init_attention_metadata(self, forward_meta: ForwardMeta):
        metadata = TokenSparseAttentionMetadata()
    ...
    def forward_mixed(
        ...
        cache_ik = forward_meta.caches[3 * layer.layer_id + 2]
