...
void per_token_group_quant_8bit(const paddle::Tensor& input,
...
__global__ void per_token_group_quant_8bit_packed_kernel(
  ...
  T* smem = reinterpret_cast<T*>(smem_raw);
  T* smem_group = smem + local_group_id * group_size;
  const float y_s = ComputeGroupScale<T, true>(group_input,
                                               smem_group,
                                               group_size,
                                               lane_id,
                                               threads_per_group,
...
void per_token_group_quant_8bit_packed(const paddle::Tensor& input,
                                       paddle::Tensor& output_q,
...
void per_token_group_quant_fp8(const torch::Tensor& input,
  ...
  per_token_group_quant_8bit(input,
                             output_q,
                             output_s,
                             group_size,
                             eps,
